...
model_embedder.load_state_dict(torch.load('models/model_39/t_encoder_embedder_test_best.pth'))
model_estimator.load_state_dict(torch.load('models/model_39/t_encoder_estimator_test_best.pth'))
model_embedder.eval()
model_estimator.eval()

tabular = diccionario['10518.0'].values
